...
**NAMES:** Storm Zierden & Theresa Binnings  
...
```{r}
#| label: add-label-1
# use tibble to create dataframe
...
```{r}
#| label: top_secret_math
#changed top_secret to code break; add math
...
```{r}
#| label: rational_comparison
#added rational comparison
...
```{r}
#| label: vector_matrix
#vector to matrix add five columns
...
```{r}
#| label: even_numbers_vector
#Create vector even numbers to 382
...
```{r}
#| label: math_with_matrix
#math on top_secret with even vector
